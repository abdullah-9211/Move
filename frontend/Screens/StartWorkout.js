        ...
        <View style={{ flex: 1, justifyContent: "flex-start", backgroundColor: "transparent" }}>
          ...
          {/* ... (rest of your content) */}
            ...
            <View style={{flexDirection: "row", marginTop:5, justifyContent: 'space-between', marginRight:20}}>
                ...
                <Pressable style={{flex:1, justifyContent: "flex-end"}} onPress={() => navigation.navigate('UploadVideo', {workouts:totalExercises, user: user, trainer: trainer, exerciseNames: exerciseNames, workout: workout, filenames: filenames})}>
